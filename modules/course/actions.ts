...
export const fetchPlaylistRequest = (
  payload?: string
): PayloadAction<string> => ({ type: FETCH_PLAYLIST_REQUEST, payload });
export const fetchPlaylistSuccess = (
  payload: Playlist
): PayloadAction<Playlist> => ({ type: FETCH_PLAYLIST_SUCCESS, payload });
export const fetchPlaylistError = (payload: string): PayloadAction<string> => ({
  type: FETCH_PLAYLIST_ERROR,
  payload,
});

export const toggleVideoCompleted = (
  payload: string
): PayloadAction<string> => ({ type: TOGGLE_VIDEO_COMPLETED, payload });
export const toggleVideoOpen = (payload: string): PayloadAction<string> => ({
  type: TOGGLE_VIDEO_OPEN,
  payload,
});
export const setVideoFilter = (payload: string): PayloadAction<string> => ({
