declare module 'recompose' {
  ...
  export function compose<T>(
    ...funcs: Function[]
  ): (component: React.ComponentType<any>) => React.ComponentType<T>;
  ...
  ) => React.ComponentType<TStateProps & TDispatchProps & TOwnProps>;
  export function withProps<TInnerProps, TOuterProps>(
    createProps: (ownerProps: TOuterProps) => TInnerProps
  ): (
    component: React.ComponentType<TInnerProps & TOuterProps>
